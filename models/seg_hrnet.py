...
from .sync_bn.inplace_abn.bn import InPlaceABN
...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        # stem net
        self.conv_init = nn.Conv2d(1, 3, kernel_size=1, stride=1, padding=0, bias=False)
...
class HRNetClassHeader(nn.Module):
    def __init__(self, pre_stage_channels):
        super(HRNetClassHeader, self).__init__()
...
def get_seg_model(cfg, **kwargs):
    ...
    model.init_weights()
    classheader = HRNetClassHeader(model.pre_stage_channels)
    classheader.init_weights()
    return model, classheader
